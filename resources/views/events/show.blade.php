    ...
    <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div class="p-6.5">
            ...
            <div class="mb-4.5">
                ...
                <p class="text-black dark:text-white text-xl font-bold text-primary">
            ...
            <div class="mb-4.5">
                ...
                <p class="text-black dark:text-white text-xl font-bold text-success">
                    Gratis
                </p>
            </div>
            @endif
        ...
        ($event->status === 'rejected' ? 'bg-danger text-danger' : 'bg-warning text-warning') }}">
            ...
            <div class="flex justify-end gap-4">
                ...
                @else
                @if(!$event->is_free)
                <a href="{{ route('transactions.create', $event) }}"
                    class="flex justify-center rounded bg-primary py-2 px-6 font-medium text-gray hover:bg-opacity-90">
                    Daftar & Bayar
                </a>
                @else
                <a href="#"
                    class="flex justify-center rounded bg-success py-2 px-6 font-medium text-gray hover:bg-opacity-90">
                    Daftar Gratis
                </a>
                @endif
                @endif
